    ...
    <div  class="col-6 col-md-3 col-lg-2">
      <div class="card m-2 p-1 book-card">
        ...
        <div class="card-body">
          ...
          <h6 class="card-subtitle mb-2 text-muted">{{book.unit_price}}$</h6>
          <p class="card-subtitle mb-2 text-muted fst-italic mb-0" style="font-size: 14px">Stock: {{book.available_quantity}} left</p>
